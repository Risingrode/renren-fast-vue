    ...
    <el-dialog :title="!dataForm.attrGroupId ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible"
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
            ...
            <el-form-item label="所属分类id" prop="catelogId">
                ...
                <el-cascader v-model="dataForm.catelogIds" :options="categorys" :props="props" filterable
                ...
                if (this.dataForm.attrGroupId) {
                    this.$http({
                        ...
                        if (data && data.code === 0) {
                            ...
                            // 查出catId的完整路径
                            this.dataFrom.catelogIds = data.attrGroup.catelogPath.split(',')
                        }
                    })
                }
            })
